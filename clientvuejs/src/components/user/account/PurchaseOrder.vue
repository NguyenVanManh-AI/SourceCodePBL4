<template>
    <div id="purchaseorder">
        <div id="header">
            <li @click="waitForConfirmation" :class="{border_bt:border_bts[0]}">Wait for confirmation</li>
            <li @click="waitingForShipping" :class="{border_bt:border_bts[1]}">Waiting for shipping</li>
            <li @click="delivering" :class="{border_bt:border_bts[2]}">Delivering</li>
            <li @click="delivered" :class="{border_bt:border_bts[3]}">Delivered</li>
            <li @click="cancelled" :class="{border_bt:border_bts[4]}">Cancelled</li>
        </div>
        <div id="content">
